...
f1 = lambda x: x**3 - 3*x**2 + 3*x - 1 # x = 1, -1
f2 = lambda x: x**5 - 4*x**4 + 3*x**3 + 9*x - 5 # x = 0.536
f3 = lambda x: np.exp(x) - x**np.exp(1) + 3*x**3 -2*x -5  # x = 

print( f1(-1))
f_com = lambda x: x**3 + np.cos(x) # a = -1, b = 0

# b_root, b_a, b_b = rf.bisection(f3, -300, 300)
n_root = rf.newton(f1, -1100)
# s_root = rf.secant(f1, -15, 17)
# r_root = rf.regular_falsi(f1, -15, 17)
